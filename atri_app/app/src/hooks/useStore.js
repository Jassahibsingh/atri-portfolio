  ...
  "Home": {
    ...
    "Image11": {
      "custom": {
        ...
        "src": "/app-assets/arrow_forward_FILL0_wght400_GRAD0_opsz20.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image20": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/right%20chevron.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image36": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/north_east_FILL0_wght400_GRAD0_opsz24.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image47": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/chevron_left_white_24dp.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image48": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/chevron_right_white_24dp.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image57": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/expand_more_white_24dp.svg"
      },
      "callbacks": {
        "onClick": [
          {
